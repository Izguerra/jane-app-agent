...
import { Users, Settings, Shield, Activity, Menu, Building2, Plug, Bot, BarChart3 } from 'lucide-react';
...
export default function DashboardLayout({
  ...
  const navItems = [
    ...
    { href: '/dashboard/business', icon: Building2, label: 'Business Profile' },
    { href: '/dashboard/integrations', icon: Plug, label: 'Integrations' },
    { href: '/dashboard/agent', icon: Bot, label: 'Agent Settings' },
