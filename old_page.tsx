...
import { ArrowRight, MessageSquare, BarChart3, Zap, Globe, Shield, Sparkles, Check } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            ...
            <FeatureCard
              ...
              title="Smart Handoff"
              description="Detects frustration or complexity and seamlessly transfers to a human agent with full context."
            />
            <FeatureCard
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
              From data to agent in minutes. Transform complex AI processes into a simple 3-step workflow that scales with your business.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative max-w-5xl mx-auto">
            {/* Connector Line (Desktop Only) */}
            <div className="hidden md:block absolute top-[2.5rem] left-[16%] right-[16%] h-[2px] border-t-2 border-dashed border-gray-300 -z-10"></div>
