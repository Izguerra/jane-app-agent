#!/usr/bin/env python3
"""
Migration script to add all missing columns to customers table.
"""
import os
import sys
...
migrations = [
    ...
    "ALTER TABLE customers ADD COLUMN IF NOT EXISTS next_follow_up_date TIMESTAMP WITH TIME ZONE;",
...
try:
    with engine.connect() as conn:
        ...
        print("✅ Added all missing columns to customers table")
